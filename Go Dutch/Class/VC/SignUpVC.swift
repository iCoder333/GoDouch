...
//  Go Dutch
//
//  Created by Florin Bogdan on 9/8/16.
...
// MARK: - Image Picker Delegates
    ...
    @IBAction func onJoin(_ sender: AnyObject) {
        ...
        Server().registerUser(name!, location: loc!, birthday: birth!, email: email!, phone: phone!, photoData: imgData) { (result, erorCode, data) in
